...
public class ArbolExpresionGrafico extends JPanel 
{
    ...
    private void calcularPosiciones() 
    {
         posicionNodos.clear();
         subtreeSizes.clear();
         NArbol root = this.miArbol.getRaiz();
         if (root != null) 
         {
    ...
    private void calcularPosicion(NArbol n, int left, int right, int top) 
    {
      if (n == null) 
          return;
    ...
    private void dibujarArbol(Graphics2D g, NArbol n, int puntox, int puntoy, int yoffs) 
    {
     if (n == null) 
         return;
